...
deepstate_make_angora <- function(){
  ...
  Sys.setenv(ANGORA_HOME=paste0(deepstate.path,"/Angora"))
  system(paste0("cd ", build_angora," ; ","CXX=",Sys.getenv("ANGORA_HOME"),"/bin/angora-clang++ ","CC=",Sys.getenv("ANGORA_HOME"),"/bin/angora-clang cmake -DDEEPSTATE_ANGORA=ON ../"," ; ", "make"))
}
